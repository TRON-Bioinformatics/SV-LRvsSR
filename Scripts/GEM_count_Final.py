...
if __name__=='__main__':
    ...
    parser.add_argument('-bam','--bamFile', help="enter coordinate sorted bam file from Long Ranger")
    parser.add_argument('-n','--n', help="enter number of cores to be used")
    parser.add_argument('-out','--output', help="enter final csv file to which features would be added")
    parser.add_argument('-w','--window', help="window size\n DEFAULT=1000bp", default=int(1000))
