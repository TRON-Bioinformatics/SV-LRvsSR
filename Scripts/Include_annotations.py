...
if __name__=='__main__':
    parser=argparse.ArgumentParser(description="Include repetitive regions covered by structural variations and poor mappability regions")
    parser.add_argument('-repeatMasker','--repeats', help="enter repeatMasker file")
    parser.add_argument('-mappability','--mappability', help="enter mappability trak file")
    parser.add_argument('-File','--File', help="enter .tsv file with structural variations")
    parser.add_argument('-BAM','--BAMshort',help="enter BAM file with aligned short-reads")
    parser.add_argument('-BAMLinked','--BAMLinked', help="enter BAM file with aligned linked-reads")
    parser.add_argument('-Threads','--processes', help="Enter number of cores")
    ...
    FinalCombinedFile.to_csv('Combined_SR_LR_500_annotated.tsv', sep='\t', index=False)
