...
if __name__=='__main__':
    ...
    parser.add_argument('-chromLengths','--lengthChrom',help="enter txt file containing length of chromosomes")
    parser.add_argument('-delly','--delly',help="enter full path for delly vcf files in order:DEL,DUP,INV,TRA")
