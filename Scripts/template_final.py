...
def findPercentMapping(cigar_read):
    ...
    for i in cigar_read:
        ...
        if tmp[0]==0:
            ...
            totalLen+=float(tmp[1])
    # print "matches, totalLen", matches, totalLen
    # print cigar_read, float((matches/totalLen)*100)
...
def calculate_Junc_Span(FaFile, bamFile, junc_cutoff, outdir, requantbp, typeof):
    ...
    for ref_id in ref_ids:
        ...
        for query_name in list(set(list(reads_on_ref_l.keys())+list(reads_on_ref_r.keys()))):
            ...
            # if end_r1!=None and start_r1< end_r1 < bp_pos:
            #     Percent_r1=findPercentMapping(cigar_r1)
            #     if Percent_r1>50:
            #         reads_gene_a +=1
            # if end_r2 != None and start_r2< end_r2 < bp_pos:
            #     # print "gene_a-2"
            #     Percent_r2=findPercentMapping(cigar_r2)
            #     # print "Percent_r2", Percent_r2
            #     if Percent_r2>50:
            #         reads_gene_a +=1
            # if start_r1!=None and end_r1 > start_r1 > bp_pos:
            #     # print "gene_b"
            #     Percent_r1=findPercentMapping(cigar_r1)
            #     # print "Percent_r1",Percent_r1
            #     if Percent_r1>50:
            #         reads_gene_b +=1
            # if start_r2 != None and end_r2> start_r2 > bp_pos:
            #     # print "gene_b-2"
            #     Percent_r2=findPercentMapping(cigar_r2)
            #     # print "Percent_r2", Percent_r2
            #     if Percent_r2>50:
